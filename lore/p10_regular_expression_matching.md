...
Відразу скажу, що наведене рішення не є оптимальним по швидкості чи по памʼяті, і ціль статті - показати ітеративно підходи до вирішення складних задач. Більш оптимальне рішення є на [моєму гітхабі](https://github.com/Sergei1984/leetcode/blob/main/src/p010_hard_regular_expression_matching_optimized.rs), і я додумався до того алгоритму вже після написання статті.
...
Це все ще є комбінаторна перевірка, але значно ефективніша.

Pеалізація цього алгоритму бʼє 100% за швидкістю і 60% відсотків за памʼяттю, але має на порядок більший обʼєм коду і кончені алгоритми з кучею граничних умов.
...
Також не нехтуйте категорією задачі. Якщо на літкоді вона відноситься до складних, то вона, напевно, і є складна, і якщо алгоритм знайшловся легко і просто, то тричі подумайте і перевірте, чи справді він зможе вирішити задачу.
